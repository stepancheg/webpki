...
pub enum Error {
    ...
    /// The certificate doesn't contain a subjectAltName extension.
    ///
    /// webpki requires the DNS name(s) be in the subjectAltName
    /// extension as required by the CA/Browser Forum Baseline
    /// Requirements and as recommended by RFC6125.
    NoSubjectAltName,
